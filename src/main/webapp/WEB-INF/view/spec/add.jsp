...
<button type="button" class="btn btn-primary" onclick="addSpecName()"><i class="glyphicon glyphicon-plus"></i>添加规格</button>
...
<table class="table table-bordered" id="specTable">
    <tr>
        ...
        <td>
            <button type="button" class="btn btn-info" onclick="addSpecValue(this)"><i class="glyphicon glyphicon-plus"></i>添加规格值</button>
        </td>
    </tr>
</table>
...
<div style="display: none" id="specNameDiv">
    <table class="table table-bordered">
        <tr>
            <td>
                 <button type="button" class="btn btn-danger" onclick="deleteSpecName(this)"><i class="glyphicon glyphicon-trash"></i>删除</button>
            </td>
        </tr>
        <tr>
            <td style="width: 100px;">规格名:</td>
