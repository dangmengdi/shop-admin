...
<body>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">地区树展示
            <button type="button" class="btn btn-success" onclick="addArea()"><span class="glyphicon glyphicon-plus"></span>添加</button>
            <button type="button" class="btn btn-warning" onclick="updateArea()"><span class="glyphicon glyphicon-pencil"></span>修改</button>
            <button type="button" class="btn btn-danger" onclick="deleteArea()"><span class="glyphicon glyphicon-trash"></span>删除</button>
        </div>
