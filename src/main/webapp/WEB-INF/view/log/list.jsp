                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="emport">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="info" id="info" placeholder="请输入记录内容...">
                                </div>
                            ...
                            <div style="text-align: center">
                                <button type="button" class="btn btn-primary" onclick="queryLog()"><i class="glyphicon glyphicon-search"></i>查询</button>
