                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="emportForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="minBirthday" id="minBirthday" placeholder="请选择最小生日...">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                                            <input type="text" class="form-control" name="maxBirthday" id="maxBirthday" placeholder="请选择最大生日...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div style="text-align: center">
                                    <button type="button" class="btn btn-primary" onclick="queryUserParam()"><i class="glyphicon glyphicon-search"></i>查询</button>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">用户列表
                        <button type="button" class="btn btn-success" onclick="addUser()"><span class="glyphicon glyphicon-plus"></span>添加用户</button>
                        <button type="button" class="btn btn-danger" onclick="deleteUsers()"><i class="glyphicon glyphicon-trash"></i>批量删除</button>
                        <button type="button" class="btn btn-success" onclick="exportExcel()"><i class="glyphicon glyphicon-download"></i>导出Excel</button>
                        <button type="button" class="btn btn-success"><i class="glyphicon glyphicon-upload"></i>导入Excel</button>
                        <button type="button" class="btn btn-success" onclick="importWord()"><i class="glyphicon glyphicon-download"></i>导出Work</button>
