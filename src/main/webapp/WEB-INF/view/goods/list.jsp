                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="emport">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="productName" id="goodsName" placeholder="请输入商品名称...">
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">商品列表
                    <button type="button" class="btn btn-success" onclick="toAddGoods()"><i class="glyphicon glyphicon-plus"></i>添加商品</button>
                    <button type="button" class="btn btn-success" onclick="deleteHotProductCache()"><i class="glyphicon glyphicon-plus"></i>手工清缓存</button>
                </div>
                <div class="panel-body">
