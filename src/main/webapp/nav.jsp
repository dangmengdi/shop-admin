...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <c:if test="${!empty user.loginDate}">
            ...
            <font color="#ccffff"><fmt:formatDate value="${user.loginDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></font>
        </c:if>
        ...
        <a href="/user/removeUser.jhtml"><font style="color:#00FFFF;margin-left:50px;font-size:15px;font-family:黑体;">退出</font></a>
    </div>
</nav>
